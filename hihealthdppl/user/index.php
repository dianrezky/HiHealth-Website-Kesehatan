...
<html class="no-js" lang="zxx">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="ti-heart" aria-hidden="true"></i> by <a href="http://hitkhealth.xyz/" target="_blank">HiHealth</a>
